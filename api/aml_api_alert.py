...
# Setup database for alert logging
DATABASE_URL = "sqlite:///./alerts.db"  # You can switch to PostgreSQL in production
...
class Alert(Base):
    ...
    payment_format = Column(String)
    payment_currency = Column(String)
    receiving_currency = Column(String)
...
def predict(input_data: AMLInput):
    try:
        ...
        # Log suspicious transactions to database
        if risk_level in ["High", "Medium"]:
            ...
            alert = Alert(
                ...
                hour_of_day=input_data.hour_of_day,
                day_of_week=input_data.day_of_week,
                payment_format=input_data.payment_format,
                payment_currency=input_data.payment_currency,
                receiving_currency=input_data.receiving_currency,
